...
class VAE_439(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
                ...
                BasicConv2d(192, 192, kernel_size=3),
                nn.MaxPool2d(kernel_size=3, stride=2),
        ...
        self.decoder = nn.Sequential(
                ...
                BasicConvTranspose2d(64, 192, kernel_size=1),
                BasicConvTranspose2d(192, 192, kernel_size=3, stride=3),
                BasicConvTranspose2d(192, 80, kernel_size=1),
